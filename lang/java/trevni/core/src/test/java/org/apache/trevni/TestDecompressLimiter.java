...
public class TestDecompressLimiter {
  ...
  void defaultLimitIs200MB() {
    ...
    assertThrows(TrevniRuntimeException.class, () -> DecompressLimiter.checkLimit(200L * 1024 * 1024 + 1));
  }
  ...
  void resetLimitReadsCustomProperty() {
    ...
    assertThrows(TrevniRuntimeException.class, () -> DecompressLimiter.checkLimit(5001));
  }
  ...
  void resetLimitCanBeCalledRepeatedly() {
    setLimit(1000);
    assertThrows(TrevniRuntimeException.class, () -> DecompressLimiter.checkLimit(1001));

    setLimit(2000);
    assertDoesNotThrow(() -> DecompressLimiter.checkLimit(1001));
    assertThrows(TrevniRuntimeException.class, () -> DecompressLimiter.checkLimit(2001));
  }
  ...
  void checkLimitThrowsOneByteOverBoundary() {
    setLimit(10_000);
    assertThrows(TrevniRuntimeException.class, () -> DecompressLimiter.checkLimit(10_001));
  }
  ...
  void checkLimitExceptionContainsUsefulDetails() {
    setLimit(1024);
    TrevniRuntimeException ex = assertThrows(TrevniRuntimeException.class, () -> DecompressLimiter.checkLimit(2048));
